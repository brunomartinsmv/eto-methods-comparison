...
**PT**
Use `CITATION.cff` ou a secao "How to Cite" do `README.md` para citar o repositorio. O DOI de versao arquivado no Zenodo e `10.5281/zenodo.21327869`; o DOI conceitual para todas as versoes e `10.5281/zenodo.18615049`.
...
**EN**
Use `CITATION.cff` or the "How to Cite" section in `README.md` to cite the repository. The archived Zenodo version DOI is `10.5281/zenodo.21327869`; the concept DOI for all versions is `10.5281/zenodo.18615049`.
